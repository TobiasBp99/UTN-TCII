# -*- coding: utf-8 -*-
"""
Created on Sat Nov 13 19:01:43 2021
...
z3 = s*2/7 + 1
z2 = s*12/49 + 1/(s*49/48)

print(sp.simplify(z2),sp.simplify(z3))

print(sp.simplify((1/z2)+(1/z3)))

zp = sp.simplify((z2*z3)/(z2+z3))

t = sp.simplify(zp / (zp+s*(12/7)))
